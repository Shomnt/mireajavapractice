...
import labs.lab15_16.exceptions.AlcoholForNotMatureCustomerException;
import labs.lab15_16.exceptions.EmptyOrderListException;
import labs.lab15_16.exceptions.NoFreeTablesException;
import labs.lab15_16.back.Dish;
import labs.lab15_16.back.Drink;
import labs.lab15_16.back.DrinkTypeEnum;
import labs.lab15_16.back.MenuItem;
import labs.lab15_16.back.InternetOrder;
import labs.lab15_16.back.Order;
import labs.lab15_16.back.TableOrder;
import labs.lab15_16.back.InternetOrderManager;
import labs.lab15_16.back.TableOrderManager;
...
public class Controller implements Runnable{
    ...
    public void run() {
        while (true) {
            if (!kw.isVisible() && !iw.isVisible() && !ww.isVisible() && !mw.isVisible())
                System.exit(0);
