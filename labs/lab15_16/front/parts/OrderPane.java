...
public class OrderPane extends JTabbedPane {
    ...
    public static class MenuItemPanel extends JPanel{
        ...
        private JTextField tf, name, desc, cost, desc_type;
        private JPanel mp;
        private JLabel desc_inf;
        ...
        MenuItemPanel(int tNum){
            ...
            var l = new JLabel("Наименование: ");
            l.setLabelFor(name);
            desc = new JTextField();
            desc.setPreferredSize(new Dimension(60, 20));
            var ld = new JLabel("Примечание: ");
            ld.setLabelFor(name);
            cost = new JTextField();
            cost.setPreferredSize(new Dimension(60, 20));
            var l2 = new JLabel("Стоймость: ");
            l2.setLabelFor(name);
